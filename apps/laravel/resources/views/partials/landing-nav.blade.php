    ...
    <div class="relative max-w-7xl mx-auto container-pad floating-site-nav-frame">
        <div class="flex justify-between items-center h-16 sm:h-[68px]">
            ...
            <div class="flex items-center gap-2.5 sm:gap-3">
                <!-- Language Toggle (Desktop & Mobile header) -->
                <div class="lang-switcher" role="group" aria-label="{{ __('landing.nav.lang_switch') }}">
                ...
                <a href="https://wa.me/573113894136" target="_blank" rel="noopener noreferrer" class="nav-whatsapp-btn flex" aria-label="{{ __('landing.nav.whatsapp_aria') }}">
